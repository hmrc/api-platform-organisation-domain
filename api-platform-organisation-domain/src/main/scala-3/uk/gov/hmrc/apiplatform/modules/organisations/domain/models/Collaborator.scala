...
object Collaborator {
  ...
  def role(me: Collaborator): Collaborator.Role = me match {
    case _: Collaborators.Administrator         => Collaborator.Roles.Administrator
    case _: Collaborators.ResponsibleIndividual => Collaborator.Roles.ResponsibleIndividual
    case _: Collaborators.Member                => Collaborator.Roles.Member
  }

  def describeRole(me: Collaborator): String = me match {
    case _: Collaborators.Administrator         => Roles.Administrator.toString
    case _: Collaborators.ResponsibleIndividual => Roles.ResponsibleIndividual.toString
    case _: Collaborators.Member                => Roles.Member.toString
  }
  ...
  given OFormat[Collaborators.ResponsibleIndividual] = Json.format[Collaborators.ResponsibleIndividual]
  given OFormat[Collaborators.Member]                = Json.format[Collaborators.Member]
